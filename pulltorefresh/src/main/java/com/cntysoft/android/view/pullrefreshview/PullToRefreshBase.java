...
import com.cntysoft.android.view.pullrefreshview.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T>{
    ...
    /**表示是否消费了touch事件，如果是，则不调用父布局的onTouchEvent方法*/
    ...
    private void refreshLoadingViewsSize(){
        ...
        Log.i(TAG,"mHeaderHeight: "+mHeaderHeight+" mFooterHeight: "+mFooterHeight+" headerHeight: "+headerHeight+" footerHeight: "+ footerHeight);
    ...
    /**
     *I/PullToRefresh﹕ SizeChanged
     *I/PullToRefresh﹕ w: 480 h: 762 oldw: 0 oldh: 0
     *I/PullToRefresh﹕ mHeaderHeight: 0 mFooterHeight: 0 headerHeight: 90 footerHeight: 90
     *I/PullToRefresh﹕ viewTree
     *I/PullToRefresh﹕ mHeaderHeight: 90 mFooterHeight: 90 headerHeight: 90 footerHeight: 90
     */
    @Override
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(absDiff > mTouchSlop || isPullRefreshing() || isPullLoading()){
                    ...
                    if(isPullRefreshEnabled() && isReadyForPullDown()){
                        ...
                        Log.i(TAG,mIsHandledTouchEvent + " "+ getScrollYValue());
