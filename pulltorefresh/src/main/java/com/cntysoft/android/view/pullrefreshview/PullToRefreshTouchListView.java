...
import com.cntysoft.android.view.TouchListView;

/**
 * Created by Administrator on 2015/6/3.
 */
public class PullToRefreshTouchListView extends PullToRefreshBase<TouchListView> implements AbsListView.OnScrollListener{
    ...
    public PullToRefreshTouchListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setPullLoadEnabled(false);
    }

    @Override
    protected TouchListView createRefreshableView(Context context, AttributeSet attrs) {
        TouchListView localTouchListView = new TouchListView(context, attrs);
        localTouchListView.setId(R.id.list);
        this.mListView = localTouchListView;
        localTouchListView.setOnScrollListener(this);
        return localTouchListView;
    }
