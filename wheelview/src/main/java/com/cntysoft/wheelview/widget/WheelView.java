...
import com.cntysoft.wheelview.R;
import com.cntysoft.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    protected void notifyClickListenerAboutClick(int item){
            ...
            case MotionEvent.ACTION_UP:
                if(!isScrollingPerformed){
                    ...
                    if(items != 0 && isValidItemIndex(currentItem + items)){
                        notifyClickListenerAboutClick(currentItem + items);
                    }
                    break;
                }
        }
     ...
     *            scrolling duration
     */
    public void scroll(int itemToScroll,int time){
        int distance = itemToScroll * getItemHeight() - scrollingOffset;
